...
const Testimonial = () => {
	...
	return (
		<div
			id="testimonials"
			className="relative mx-auto w-full max-w-(--breakpoint-xl) overflow-hidden px-6 py-6 xs:py-12"
		>
			<h2 className="mb-8 xs:mb-14 text-center font-bold text-[56px] tracking-tight">
				What <span className="text-primary">Our Customers</span> Are Saying
			</h2>
